...
| Ingest pipeline (Stage A–B) | 🔲 Deferred | BUILD_07 — no Scrapy spiders or extraction tasks yet |
...
- **Read first:** [03_M1_Data_Collection.md §1 (Scrapy framework choice)](03_M1_Data_Collection.md) + [03_M1_Data_Collection.md](03_M1_Data_Collection.md).
...
- **Do this next:** copy the `classify_pdf()` skeleton from [03_M1_1 §1](03_M1_Data_Collection.md) and write the unit test against a fixture PDF first.

### Step 2d — Language detection + per-line routing

- **Read first:** [10_M1_Sinhala_Tamil_NLP.md](10_M1_Sinhala_Tamil_NLP.md) + [10_M1_Sinhala_Tamil_NLP.md](10_M1_Sinhala_Tamil_NLP.md).
...
- **Read first:** [04_M1_Preprocessing_Pipeline.md](04_M1_Preprocessing_Pipeline.md) + sub-step companions [04_M1_1](04_M1_Preprocessing_Pipeline.md) · [04_M1_2](04_M1_Preprocessing_Pipeline.md) · [04_M1_3](04_M1_Preprocessing_Pipeline.md).
...
**Phase 2 DoD (overall):** invoking the pipeline on a fresh `gazette.lk` URL ends with `m1_regulations` row at `status='extracted'`, all metadata fields populated. Status badges in 14_M1_1 ([Pipeline State Tracking](14_M1_Tracking_Workflows.md)) flip from 🟡 to ✅ on this surface.
...
- **Read first:** [09_M1_Annotation_Guidelines.md](09_M1_Annotation_Guidelines.md) + [09_M1_Annotation_Guidelines.md](09_M1_Annotation_Guidelines.md).
...
- **Read first:** [05_M1_Model_Architecture.md §3–4](05_M1_Model_Architecture.md) + [05_M1_Model_Architecture.md](05_M1_Model_Architecture.md) + [06_M1_Training_Evaluation.md](06_M1_Training_Evaluation.md) + augmentation companion [06_M1_1](06_M1_Training_Evaluation.md).
...
- **Do this next:** start by hard-coding the small LoRA ablation (`r ∈ {8, 16, 32}`) from [05_M1_3](05_M1_Model_Architecture.md) and run on the first 300 labels.
...
- **Read first:** [07_M1_Deployment_Integration.md](07_M1_Deployment_Integration.md) + [07_M1_Deployment_Integration.md](07_M1_Deployment_Integration.md).
...
**Phase 3 DoD (overall):** new gazettes from Phase 2 auto-classify; `m1_regulations.change_category` + `affected_sectors[]` + `confidence` populate via the Fly inference task. Status badges in [14_M1_2 (review queue)](14_M1_Tracking_Workflows.md) flip from 🔲 to 🟡 (queue UI still deferred).
...
- **Read first:** [12_M1_Monitoring_Maintenance.md](12_M1_Monitoring_Maintenance.md) + [12_M1_Monitoring_Maintenance.md](12_M1_Monitoring_Maintenance.md).
...
**Phase 4 DoD (overall):** the pipeline runs end-to-end without human intervention; lag data flows to the views. SME-side [14_M1_8 (deadline + alerts)](14_M1_Tracking_Workflows.md) status flips from 🔲 to 🟡 (UI deferred to BUILD_13).
...
|---|---|---|---|
| A1 — Pipeline-state tracking | Admin | Phase 2 (data) + BUILD_13 (UI) | [14_M1_1](14_M1_Tracking_Workflows.md) |
| A2 — Review queue triage | Admin | Phase 3 (data) + BUILD_13 (UI) | [14_M1_2](14_M1_Tracking_Workflows.md) |
| A3 — Expert verification | Admin | ✅ Already shipped (Phase 1) | [14_M1_3](14_M1_Tracking_Workflows.md) |
| A4 — Lag analytics dashboard | Admin | Phase 4 (data) + BUILD_13 (UI) | [14_M1_4](14_M1_Tracking_Workflows.md) |
| S1 — Regulation discovery (sector filter) | SME | Phase 4 (data) + BUILD_13 (UI) | [14_M1_5](14_M1_Tracking_Workflows.md) |
| S2 — Awareness survey participation | SME | ✅ Already shipped (Phase 1) | [14_M1_6](14_M1_Tracking_Workflows.md) |
| S3 — Compliance / action-taken tracker | SME | Phase 5 (data) + BUILD_13 (UI) | [14_M1_7](14_M1_Tracking_Workflows.md) |
| S4 — Deadline + alert history | SME | Phase 4 (data) + BUILD_13 (UI) | [14_M1_8](14_M1_Tracking_Workflows.md) |
| X9 — Category × Sector workflows | Both | Reference doc — applies at every phase | [14_M1_9](14_M1_Tracking_Workflows.md) |
