...
> Companion to [[PHASE2_INGEST_EXTRACTION_ANALYSIS]] §6.6 and [[PHASE2_GAP_CLOSURE_PLAN]] §6.6. **Status: implemented (Session 67, 2026-07-21).** Code in `C:\Reasearch\xyz\enigmatrix-backend`.
...
- Feed `needs_metadata_review` count into the monthly quality probe ([[PHASE2_QUALITY_MONITORING_PLAN]]) as a trend metric.
