...
CREATE TABLE survey_responses (
    ...
    survey_instrument    TEXT NOT NULL,                -- 'awareness_v1' | 'knowledge_v1' | ...
...
### Question count
- Maximum **40 questions** per survey instrument. Beyond this, abandonment rate climbs.
- Module 1 awareness survey: ~15 questions.
- Module 2 knowledge test: ~30–40 questions (knowledge tests can be longer because they have one right answer per question).
- Module 3 vulnerability survey: ~20 questions.
