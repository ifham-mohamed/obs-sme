...
The drift-triggered retraining path (§5c) still stays dormant until Phase 3 ships a model (classifier confidence is NULL everywhere), consistent with [[PHASE4_SCHEDULERS_ALERTS_ANALYSIS]] §4c.
