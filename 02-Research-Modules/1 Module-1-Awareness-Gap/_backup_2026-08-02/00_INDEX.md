...
| SME awareness survey responses | ≥ 100 unique SMEs                  | Instrument and authenticated `/surveys/module/m1` flow exist; public recruitment route and field responses remain open |
...
- **Live integration has moved past the earlier blocker:** gazettes have been classified by the frozen model, and `/admin/m1/pipeline/classifier-review` now consumes disabled, margin, nullable-confidence, and configured-threshold modes. Remaining evidence work is operating-threshold selection, review quality, margin-aware monitoring, and the final F6 analysis.
...
| E     | Summarisation      | **Backend slice shipped and live-backfilled.** Anchor-bound constrained generation writes `summary_en` with provenance/status/quality flags; first evidence recorded 380 generated, 11 review-required, 751 pending. Human faithfulness review, review UI, and full coverage remain open. See [19_M1_Regulation_Summarization.md](19_M1_Regulation_Summarization.md) |
